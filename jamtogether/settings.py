"""
Django settings for jamtogether project.
...
INSTALLED_APPS = [
    ...
    'apps.jtapi.apps.JTApiConfig',
]

ASGI_APPLICATION = 'jamtogether.asgi.application'
...
WSGI_APPLICATION = 'jamtogether.wsgi.application'
